...
namespace ConsoleTestClient
{
    public class Program
    {
        ...
        {    //authorization server parameters owned from the client
            ...
            Uri authorizationServerTokenIssuerUri = new Uri("http://localhost:5000/connect/token");
        ...
        private static async Task<string> RequestValuesToSecuredWebApi(AuthorizationServerAnswer authorizationServerToken)
        {
            ...
            using (HttpClient httpClient = new HttpClient())
            {
                ...
                HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, "http://localhost:63304/api/values");
